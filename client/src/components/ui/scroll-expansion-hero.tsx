...
interface ScrollExpandMediaProps {
  ...
  textBlend?: boolean;
  children?: ReactNode;
  /** Ref of the scrollable container (defaults to window scroll behaviour) */
...
const ScrollExpandMedia = ({
  ...
  useEffect(() => {
    const handleWheel = (e: WheelEvent) => {
      ...
      if (mediaFullyExpanded && e.deltaY < 0 && scrollTop <= 5) {
        setMediaFullyExpanded(false);
        e.preventDefault();
    ...
    const handleTouchMove = (e: TouchEvent) => {
      ...
      if (mediaFullyExpanded && deltaY < -20 && scrollTop <= 5) {
        setMediaFullyExpanded(false);
        e.preventDefault();
      } else if (!mediaFullyExpanded) {
        e.preventDefault();
  ...
  }, [scrollProgress, mediaFullyExpanded, touchStartY, scrollContainerRef]);
          ...
          <div className="container mx-auto flex flex-col items-center justify-start relative z-10">
            <div className="flex flex-col items-center justify-center w-full h-[100dvh] relative">
              ...
              >
                ...
                {/* Date + scroll hint below the media card */}
                <div className="flex flex-col items-center text-center relative z-10 mt-4 transition-none">
                  ...
                  {scrollToExpand && (
                    <p
                      className="text-blue-200/80 font-medium text-center text-sm mt-1"
                      style={{ transform: `translateX(${textTranslateX}vw)` }}
                    >
                      {scrollToExpand}
                    </p>
              ...
              >
                <motion.h2
                  className="text-4xl md:text-5xl lg:text-6xl font-bold text-blue-100 transition-none drop-shadow-lg"
                  style={{ transform: `translateX(-${textTranslateX}vw)` }}
                >
                  {firstWord}
                </motion.h2>
                <motion.h2
                  className="text-4xl md:text-5xl lg:text-6xl font-bold text-center text-blue-100 transition-none drop-shadow-lg"
                  style={{ transform: `translateX(${textTranslateX}vw)` }}
                >
                  {restOfTitle}
                </motion.h2>
